...
`build_advising_hub.py` (the single-file dashboard builder, ~160 KB) is stored here as ordered
...
```
f13b0a3b291ca8aeb0c754c329f7bf6662715368
```
...
part_04 = 1601–1960, part_05 = 1961–end). See `../REBUILD.md` for the full rebuild specification.
